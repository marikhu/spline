    ...
    namespace tk
    {
        ...
        void band_matrix::lu_decompose()
        {
            ...
            for (int i = 0; i < this->dim(); i++)
            {
                ...
                this->operator()(i,
                                 i) = 1.0;          // prevents rounding errors
            }
        ...
        double spline::operator()(double x) const
        {
            ...
            {
                // interpolation
                interpol = ((m_a[idx] * h + m_b[idx]) * h + m_c[idx]) * h +
                           m_y[idx];
            }
            return interpol;
        }
        ...
        double spline::deriv(int order, double x) const
        {
            ...
            else
            {
                ...
                {
                    case 1:
                        interpol = (3.0 * m_a[idx] * h + 2.0 * m_b[idx]) * h +
                                   m_c[idx];
                        break;
                    case 2:
